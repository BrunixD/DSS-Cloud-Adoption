...
export const slidesData = [
  ...
  [
    ...
    <><h3>Part 2: Design Science Research (DSR)</h3><p>To address the identified gap, we used DSR to <strong>build and evaluate an IT artifact</strong>.</p><figure><img src="./assets/dsr-model.png" alt="DSR Model" style={{ maxHeight: '45vh' }}/><figcaption>DSR Methodology Process Model</figcaption></figure></>
  ],
